...
public class IngredientService {
    ...
    public interface IngredientClassificationAssistant {
        ...
        @UserMessage("""
                     ...
                     **酱料类包括**：
                     - 调味酱（酱油、醋、蚝油、豆瓣酱、辣椒酱、番茄酱等）
                     - 调味料（盐、糖、味精、鸡精、胡椒粉、五香粉、花椒粉等）
                     - **花椒类**（青花椒、红花椒、麻椒、花椒粒等）
                     - **淀粉类**（玉米淀粉、红薯淀粉、土豆淀粉、生粉、面粉等）
                     - 油类（食用油、香油、辣椒油等）
                     - 料酒、米酒、黄酒等
                     
                     ## 特别注意
                     
                     - 蒜末、姜末、葱花等虽然用于调味，但归入**蔬菜水果类**（因为是新鲜蔬菜切制）
                     - 淀粉、面粉等虽然是主食原料，但归入**酱料类**（因为主要作为调味增稠使用）
                     - 花椒、青花椒等香料归入**酱料类**
                     - 菌菇类（包括所有蘑菇）归入**蔬菜水果类**
                     ...
                     用户输入：
                     分类标签：蔬菜水果、肉禽蛋、酱料
                     食材列表：海鲜菇、香菇、金针菇、猪肉、鸡精、白菜、青花椒、淀粉、蒜末
